...
class BaseStage extends FlxBasic
{
	...
	// Events
	public function eventCalled(eventName:String, value1:String, value2:String, flValue1:Null<Float>, flValue2:Null<Float>, strumTime:Float, ?value3:String, ?value4:String) {}
